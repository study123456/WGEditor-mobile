//
//  WGAVRichEditorViewController.m
//  WGRichTextEditor
//
...
@interface WGAVRichEditorViewController ()
@property (nonatomic,strong) WGEditorToolBar *toolBarView;
@end

@implementation WGAVRichEditorViewController
- (WGEditorToolBar *)toolBarView{
    if (_toolBarView == nil) {
        CGFloat toolBarH = IS_IPhoneX_All?50:KWEditorBar_Height;
        _toolBarView = [[WGEditorToolBar alloc] initToolBarStyle:WGEditorToolBarStyleFull withFrame:CGRectMake(0,WG_SCREEN_HEIGHT - toolBarH - WG_SafeAreaTopHeight, self.view.width, toolBarH)];
    }
    return _toolBarView;
}
- (void)viewDidLoad {
